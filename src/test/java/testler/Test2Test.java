...
public class Test2Test {
  ...
  public void test2() {
    ...
    // 11 | type | xpath=//input[@name=' '] | kalem
    driver.findElement(By.xpath("//input[@name=\' \']")).sendKeys("kalem");
    ...
    // 22 | click | xpath=//*[@id="dynamicText2"] | 
    driver.findElement(By.xpath("//*[@id=\"dynamicText2\"]")).click();
    // 23 | type | //*[@id="dynamicText2"] | asd
    driver.findElement(By.xpath("//*[@id=\"dynamicText2\"]")).sendKeys("asd");
    // 24 | click | css=.btn-wrapper:nth-child(1) > .btn | 
    driver.findElement(By.cssSelector(".btn-wrapper:nth-child(1) > .btn")).click();
    // 25 | click | css=.total-price-area__right:nth-child(3) | 
    driver.findElement(By.cssSelector(".total-price-area__right:nth-child(3)")).click();
    // 26 | assertText | css=.discount-text > .price-currency | TL
